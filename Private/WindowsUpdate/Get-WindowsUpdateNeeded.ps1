function Get-WindowsUpdateNeeded {
    ...
    try {
        ...
        Write-Debug -Message '$Updates2Install = New-Object -TypeName ''System.Collections.Generic.List[System.__ComObject]'''
        $Updates2Install = New-Object -TypeName 'System.Collections.Generic.List[System.__ComObject]'
        ...
        if ($SearchResult.Updates.Count -gt 0) {
            ...
            foreach ($Item in $Updates) {
                ...
                if ($Item) {
                    Write-Debug -Message '$Updates2Install.Add($Item)'
                    $Updates2Install.Add($Item)
                }
            }
        }

        Write-Debug -Message ('$Updates2Install: ''{0}''' -f [string]$Updates2Install.Title)
